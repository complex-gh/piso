...
var Files = []string{"Dockerfile", "entrypoint.sh", "planning-watch.sh", "context-watch.sh", "ports-watch.sh", "activity-watch.sh", "informant-help.sh", "INFORMANT.md", "MONITOR.md", "monitor-loop.sh", "package.json"}
